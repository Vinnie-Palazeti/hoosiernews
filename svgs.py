...
svgs = {
    ...
    'Hoosier Ag Today': Svg(cls="size-10 sm:size-12", version='1.1', viewbox='0 0 512 512', fill='currentColor', stroke='currentColor')(
        ft_hx('g', id='SVGRepo_bgCarrier', stroke_width='1'),
    ...
    'IBJ':Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
    ...
    'Jesse Brown': Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
    ...
    "IndyPolitics.Org": Svg(xmlns='http://www.w3.org/2000/svg', width='32', height='32', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls="size-10 sm:size-12")(
    ...
    "Indiana Capital Chronicle": Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M12 7v14'),
        Path(d='M16 12h2'),
        Path(d='M16 8h2'),
    ...
    "Coffee": Svg(cls="size-10 sm:size-12", xmlns='http://www.w3.org/2000/svg', width='32', height='32', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round')(
        Path(d='M10 2v2'),
        Path(d='M14 2v2'),
        Path(d='M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1'),
        Path(d='M6 2v2')
    ),
    "Indianapolis Recorder":Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='m11 7.601-5.994 8.19a1 1 0 0 0 .1 1.298l.817.818a1 1 0 0 0 1.314.087L15.09 12'),
        Path(d='M16.5 21.174C15.5 20.5 14.372 20 13 20c-2.058 0-3.928 2.356-6 2-2.072-.356-2.775-3.369-1.5-4.5'),
        Circle(cx='16', cy='7', r='5')
    ),
    
    'Mirror Indy': Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1'),
        Path(d='m12 15 5 6H7Z')
    ),
    
    'IndyStar':Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z')
    ),
    'Tribstar':Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M10.268 21a2 2 0 0 0 3.464 0'),
        Path(d='M22 8c0-2.3-.8-4.3-2-6'),
        Path(d='M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326'),
        Path(d='M4 2C2.8 3.7 2 5.7 2 8')
    ),
    'YouAreCurrent':Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8'),
        Path(d='M21 3v5h-5'),
        Path(d='M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16'),
        Path(d='M8 16H3v5')
    ),
    "Indiana Public Media":Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Rect(width='18', height='18', x='3', y='3', rx='2'),
        Path(d='M7 7v10'),
        Path(d='M11 7v10'),
        Path(d='m15 7 2 10')
    ),
    "WRTV":Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
    ...
    "The Indiana Citizen": Svg(
        ...
        Path(d='M10 8.94648C10.0112 7.71996 10.5211 6.32069 11.6575 5.3729C14.5106 2.99353 21.2591 6.95603 20.8207 2C24.4804 7.64147 18.4776 7.81928 18.2152 9.83766C18.0664 10.9826 20.1591 11.6114 21.3687 10.6027C21.1245 11.4521 19.5 14.8057 15 13.8206', stroke='#141B34', stroke_width='1', stroke_linecap='round', stroke_linejoin='round'),
        Path(d='M8.95445 12.0276C7.83074 10.9039 8.01032 7 8.01032 7L17 15.9897C17 15.9897 13.0961 16.1678 11.9724 15.0441', stroke='#141B34', stroke_width='1', stroke_linecap='round', stroke_linejoin='round'),
        Path(d='M8.14822 12L2.24774 19.983C1.87554 20.4866 1.92775 21.1867 2.37054 21.6295C2.81333 22.0722 3.51343 22.1245 4.01701 21.7523L12 15.8518', stroke='#141B34', stroke_width='1', stroke_linecap='round', stroke_linejoin='round'),
        Path(d='M7 10L14 17', stroke='#141B34', stroke_width='1', stroke_linecap='round', stroke_linejoin='round')
    ),
    ...
    "Daily Journal":Svg( cls='size-10 sm:size-12', xmlns='http://www.w3.org/2000/svg', viewbox='0 0 256 256')(
        Rect(width='256', height='256', fill='none'),
        Path(d='M32,216V56a8,8,0,0,1,8-8H216a8,8,0,0,1,8,8V216l-32-16-32,16-32-16L96,216,64,200Z', fill='none', stroke='currentColor', stroke_linecap='round', stroke_linejoin='round', stroke_width='16'),
        Line(x1='144', y1='112', x2='192', y2='112', fill='none', stroke='currentColor', stroke_linecap='round', stroke_linejoin='round', stroke_width='16'),
        Line(x1='144', y1='144', x2='192', y2='144', fill='none', stroke='currentColor', stroke_linecap='round', stroke_linejoin='round', stroke_width='16'),
        Rect(x='64', y='96', width='48', height='64', fill='none', stroke='currentColor', stroke_linecap='round', stroke_linejoin='round', stroke_width='16')
    ),
    ...
    "NWI Times": Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
    ...
    "Courier & Press":Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M12 3V2'),
    ...
    "The Indiana Lawyer": Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M10 2v8l3-3 3 3V2'),
        Path(d='M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20')
    ),
    "Chalkbeat":Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z')
    ),
    "Herald Times":Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M11 6a13 13 0 0 0 8.4-2.8A1 1 0 0 1 21 4v12a1 1 0 0 1-1.6.8A13 13 0 0 0 11 14H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z'),
        Path(d='M6 14a12 12 0 0 0 2.4 7.2 2 2 0 0 0 3.2-2.4A8 8 0 0 1 10 14'),
        Path(d='M8 6v8')
    ),
    
    "NWI Business":Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M12 12h.01'),
        Path(d='M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2'),
        Path(d='M22 13a18.15 18.15 0 0 1-20 0'),
        Rect(width='20', height='14', x='2', y='6', rx='2')
    ),
    "Inside Indiana Business": Svg(xmlns='http://www.w3.org/2000/svg', width='24', height='24', viewbox='0 0 24 24', fill='none', stroke='currentColor', stroke_width='1', stroke_linecap='round', stroke_linejoin='round', cls='size-10 sm:size-12')(
        Path(d='M12 16h.01'),
        Path(d='M16 16h.01'),
        Path(d='M3 19a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8.5a.5.5 0 0 0-.769-.422l-4.462 2.844A.5.5 0 0 1 15 10.5v-2a.5.5 0 0 0-.769-.422L9.77 10.922A.5.5 0 0 1 9 10.5V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2z'),
        Path(d='M8 16h.01')
    ),
    "My Wabash Valley":Svg(
        Rect(width='256', height='256', fill='none'),
        Line(x1='112', y1='112', x2='176', y2='112', fill='none', stroke='currentColor', stroke_linecap='round', stroke_linejoin='round', stroke_width='16'),
        Line(x1='112', y1='144', x2='176', y2='144', fill='none', stroke='currentColor', stroke_linecap='round', stroke_linejoin='round', stroke_width='16'),
        Rect(x='40', y='40', width='176', height='176', rx='8', fill='none', stroke='currentColor', stroke_linecap='round', stroke_linejoin='round', stroke_width='16'),
        Line(x1='80', y1='40', x2='80', y2='216', fill='none', stroke='currentColor', stroke_linecap='round', stroke_linejoin='round', stroke_width='16'),
